                        ...
                        {websites.map((web, index)=>(
                            <div key={index} className="website bg-light">
                                ...
                                <div className="buttons">
                                    <a href={web.url} target="_blank" rel="noopener noreferrer" className="btn btn-primary my-1"><i className="fas fa-globe"></i> Go to Site</a>
                                    <a href={web.gitHubRepo} target="_blank" rel="noopener noreferrer" className="btn btn-dark"><i className="fab fa-github"></i> GitHub Repo</a>
                                </div>
                            </div>
                        ))}
                    </div>
